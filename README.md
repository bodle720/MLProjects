...
* [`AWS_Tools/Computer_Vision_DMS/cvdms_cdk/`](AWS_Tools/Computer_Vision_DMS/cvdms_cdk/) — AWS/CDK data-platform work.
* [`Training_Projects/projects/GlobalWheatHeadDetection/`](Training_Projects/projects/GlobalWheatHeadDetection/) — YOLO object detection, MLflow, and model-selection workflow.
* [`Training_Projects/cvdms_training_common/`](Training_Projects/cvdms_training_common/) — shared training utilities used across projects.
