"""
Project-specific model utilities for the CVDMS EuroSAT single-label classifier.
...
def build_model(
    *,
    ...
    """
    Build a project-supported classifier model.
    """
...
def build_resnet18_classifier(
    *,
    ...
    """
    Build a ResNet18 classifier with a new task-specific final layer.
