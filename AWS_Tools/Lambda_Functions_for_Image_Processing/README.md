...
<img src="imgs/curious_cat.jpg" width="400"/>

### Original Pixel Intensity Histogram

<img src="imgs/histogram_original.png" width="700"/>

### Contrast Enhanced Image (Clip Limit = 0.03)

<img src="imgs/curious_cat_enhanced_cl_03.jpg" width="400"/>

### Histogram After CLAHE (Clip Limit = 0.03)

<img src="imgs/histogram_cl_03.png" width="700"/>

---

These outputs were generated by invoking the Lambda with a `clip_limit` of `0.03` and a `kernel_size` of `256`. The enhanced image shows improved local contrast while preserving global structure, and the histogram reflects a more evenly distributed or smoothed out intensity range. Note the spikes on either end, indicating a significant quantiy of very high and low pixel values close in value.
